...
import type { GongNumber, YinYangDun, BaShenResult } from './types';
 ...
 * @returns 八神分布
 */
export function distributeBaShen(zhiFuGong: GongNumber, type: YinYangDun = 'yang'): BaShenResult {
  // 八神顺序
  const shenOrder = ['值符', '腾蛇', '太阴', '六合', '白虎', '玄武', '九地', '九天'];

  // 洛书顺序（顺时针）
  const clockwiseOrder: GongNumber[] = ['1', '8', '3', '4', '9', '2', '7', '6'];
  // 逆时针顺序
  const counterClockwiseOrder: GongNumber[] = ['1', '6', '7', '2', '9', '4', '3', '8'];
